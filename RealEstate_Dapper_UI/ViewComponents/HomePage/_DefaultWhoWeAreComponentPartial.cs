...
namespace RealEstate_Dapper_UI.ViewComponents.HomePage
{
    ...
    {
        //Doğru memory managment'ı yaparak http istekleri yapmamızı sağlayan
        //HttpClient sınıfının instance'ını oluşturmak için kullanılır.
        private readonly IHttpClientFactory _httpClientFactory; //Client factory orenği al
